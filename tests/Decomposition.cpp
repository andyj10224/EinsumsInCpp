...
TEST_CASE("CP 2") {
    ...
    test2.vector_data() =
        einsums::VectorData<double>{0.29945093, 0.0090937,  0.99788559, 0.0821231,  0.29625705, 0.80278977, 0.15189681, 0.35832086,
...
TEST_CASE("CP 3") {
    ...
    test3.vector_data() = einsums::VectorData<double>{
